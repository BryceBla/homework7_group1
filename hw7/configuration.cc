...
string Configuration::ToString () {
  ...
  s.append (Utils::Format(time_to_vote_mean_seconds_/60.0, 8, 2) + " minutes\n");
  s.append (kTag + "Min and max expected voters for this simulation:     ");
  ...
  //int offset = 6;     //seemingly unnecessary code
